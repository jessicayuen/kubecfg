...
var envRmCmd = &cobra.Command{
	Use:   "rm <env-name> <env-uri>",
	Short: "Delete a new environment within a ksonnet project",
	RunE: func(cmd *cobra.Command, args []string) error {
		flags := cmd.Flags()
		if len(args) != 1 {
			return fmt.Errorf("'env rm' takes a single argument arguments, that is the name of the environment")
		}
